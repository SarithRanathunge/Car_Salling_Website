...
function init() {
  ...
  const light4 = new THREE.DirectionalLight(0xffffff, 0);
  const light5 = new THREE.DirectionalLight(0xffffff, 0);
  ...
  loader.load("./ford_gt_lemans/scene.gltf", function(gltf) {
